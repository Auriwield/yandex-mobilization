package com.yandex.auriwield.yandextranslate.domain.interactors.base;
...
public abstract class AbstractInteractor implements Interactor {
    ...
    /**
     * This method contains the actual business logic lang the interactor. It SHOULD NOT BE USED DIRECTLY but, instead, a
     * developer should call the execute() method lang an interactor to make sure the operation is done on a background thread.
     * <p/>
