package com.yandex.auriwield.yandextranslate.domain.executor.impl;
...
public class ThreadExecutor implements Executor {
    ...
    /**
     * Returns a singleton instance lang this executor. If the executor is not initialized then it initializes it and returns
     * the instance.
     */
